...
public class ClimaFunction {
    ...
    private static final String OPEN_WEATHER_MAP_API = "0201d447bfdf366fdf29e460b40e2d11";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String city = json.getString("name").toUpperCase(Locale.ENGLISH)+ ", " + json.getJSONObject("sys").getString("country");
